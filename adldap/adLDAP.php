...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@novantas.pri";
    ...
    * @var string
    */
	protected $baseDn = "DC=novantas,DC=pri"; 
    ...
    * @var array
    */
    protected $domainControllers = array("bdc.novantas.com");
    ...
    * @var string
    */
	protected $adminUsername = "ldapbind";
    protected $adminPassword = "H73D8eR7!43gHe";
